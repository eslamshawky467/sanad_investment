                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <p class="m-0 align-self-center">@lang('payment.by') {{ $movie->vote_count }}</p>
                        </div>

                        <p><span class="font-weight-bold">@lang('payment.language')</span>: en</p>
                        <p><span class="font-weight-bold">@lang('payment.release_date')</span>: {{ $movie->release_date }}</p>
                        ...
                        <div class="row">
                            ...
                            @foreach ($movie->actors as $actor)
                                ...
                                <div class="col-md-2 my-2">
                                    <a href="{{ route('admin.payment.index', ['actor_id' => $actor->id]) }}">

...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item"><a href="{{ route('person.index') }}">{{trans('admin.persons')}}</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="tile shadow">
                <form method="post" action="{{ route('person.update','test') }}">
                    @csrf
                    {{ method_field('patch') }}
                  ...
                  <input type="hidden" name="id" value="{{$person->id}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="job" class="form-control" value="{{ old('job',$person->job) }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="link" class="form-control" value="{{ old('link',$person->link) }}" required>
                    </div>
                    <div class="form-group">
